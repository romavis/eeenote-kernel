...
#define RT5611_RESET			0X00	//RESET CODEC TO DEFAULT
#define RT5611_SPK_OUT_VOL		0X02	//SPEAKER OUT VOLUME
#define RT5611_HP_OUT_VOL		0X04	//HEADPHONE OUTPUT VOLUME
#define RT5611_PHONEIN_MONO_OUT_VOL	0X08	//PHONE INPUT/MONO OUTPUT VOLUME
#define RT5611_LINE_IN_VOL		0X0A	//LINE IN VOLUME
#define RT5611_STEREO_DAC_VOL		0X0C	//STEREO DAC VOLUME
#define RT5611_MIC_VOL			0X0E	//MICROPHONE VOLUME
#define RT5611_MIC_ROUTING_CTRL		0X10	//MIC ROUTING CONTROL
#define RT5611_ADC_REC_GAIN		0X12	//ADC RECORD GAIN
#define RT5611_ADC_REC_MIXER		0X14	//ADC RECORD MIXER CONTROL
#define RT5611_OUTPUT_MIXER_CTRL	0X1C	//OUTPUT MIXER CONTROL
#define RT5611_MIC_CTRL			0X22	//MICROPHONE CONTROL
#define RT5611_PD_CTRL_STAT		0X26	//POWER DOWN CONTROL/STATUS
#define RT5611_TONE_CTRL		0X2A	//TONE CONTROL
#define RT5611_STEREO_DAC_RATE		0X2C	//AC97 STEREO DAC RATE, DPE RATE
#define RT5611_STEREO_ADC_RATE		0X32	//AC97 STEREO ADC RATE, DPE RATE
#define	RT5611_PWR_MANAG_ADD1		0X3A	//POWER MANAGMENT ADDITION 1
#define RT5611_PWR_MANAG_ADD2		0X3C	//POWER MANAGMENT ADDITION 2
#define RT5611_PWR_MANAG_ADD3		0X3E	//POWER MANAGMENT ADDITION 3
#define RT5611_GEN_CTRL_REG1		0X40	//GENERAL PURPOSE CONTROL REGISTER 1
#define	RT5611_GEN_CTRL_REG2		0X42	//GENERAL PURPOSE CONTROL REGISTER 2
#define RT5611_PLL_CTRL			0X44	//PLL CONTROL
#define RT5611_GPIO_PIN_CONFIG		0X4C	//GPIO PIN CONFIGURATION
#define RT5611_GPIO_PIN_POLARITY	0X4E	//GPIO PIN POLARITY	
#define RT5611_GPIO_PIN_STICKY		0X50	//GPIO PIN STICKY	
#define RT5611_GPIO_PIN_WAKEUP		0X52	//GPIO PIN WAKE UP
#define RT5611_GPIO_PIN_STATUS		0X54	//GPIO PIN STATUS
#define RT5611_GPIO_PIN_SHARING		0X56	//GPIO PIN SHARING
#define	RT5611_OVER_TEMP_CURR_STATUS	0X58	//OVER TEMPERATURE AND CURRENT STATUS
#define RT5611_GPIO_OUT_CTRL		0X5C	//GPIO OUTPUT PIN CONTRL
#define RT5611_MISC_CTRL		0X5E	//MISC CONTROL
#define RT5611_VOICE_DAC_PCMCLK_CTRL1	0X64	//VOICE/PCM DAC CLOCK CONTROL 1
#define RT5611_VOICE_DAC_PCMCLK_CTRL2	0X66	//VOICE/PCM DAC CLOCK CONTROL 2
#define RT5611_PSEDUEO_SPATIAL_CTRL	0X68	//PSEDUEO STEREO /SPATIAL EFFECT BLOCK CONTROL
#define RT5611_INDEX_ADDRESS		0X6A	//INDEX ADDRESS
#define RT5611_INDEX_DATA		0X6C	//INDEX DATA
#define RT5611_EQ_STATUS		0X6E	//EQ STATUS
#define RT5611_TP_CTRL_BYTE1		0X74	//TOUCH PANEL CONTROL BYTE 1
#define RT5611_TP_CTRL_BYTE2		0X76	//TOUCH PANEL CONTROL BYTE 2
#define RT5611_TP_INDICATION		0X78	//TOUCH PANEL INDICATION
#define RT5611_VENDOR_ID1		0x7C	//VENDOR ID1
#define RT5611_VENDOR_ID2		0x7E	//VENDOR ID2
